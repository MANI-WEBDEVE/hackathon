document.addEventListener("DOMContentLoaded", () => {
  ...
  const resumeName = document.querySelector("header h1") as HTMLHeadingElement | any;
  ...
  generateButton.addEventListener("click", () => {
    ...
    let realUsername = resumeName.innerHTML.toLowerCase().replace(/\s+/g, "");
    const resumeURL = `https://${realUsername}.vercel.app/resume`;
    console.log(resumeURL);
    resumeLink.href = resumeURL;
    resumeLink.textContent = resumeURL;
